...
#
# html_title = 'django-user-tasks v0.1.0'
...
htmlhelp_basename = 'django-user-tasksdoc'
...
man_pages = [
    (master_doc, 'django-user-tasks', 'django-user-tasks Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'django-user-tasks', 'django-user-tasks Documentation',
     author, 'django-user-tasks', 'Management of user-triggered asynchronous tasks in Django projects',
     'Miscellaneous'),
]
